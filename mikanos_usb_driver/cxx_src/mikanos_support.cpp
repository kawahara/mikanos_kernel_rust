...
extern "C" int32_t cxx_xhci_controller_initialize(usb::xhci::Controller *xhc) {
...
extern "C" typedef void (*MouseObserverType)(int8_t displacement_x, int8_t displacement_y);
